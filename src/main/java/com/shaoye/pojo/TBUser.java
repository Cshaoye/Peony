...
public class TBUser implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4250178848263987408L;
	...
	/**
	 * 主要是用来修改用户的手机号码和身份证为明码
	 * 
	 * @param id
	 * @param mobile
	 * @param idNumber
	 */
	public TBUser(String id, String mobile, String idNumber) {
		this.id = id;
		this.mobile = mobile;
